...
__global__ void fireflies(float *results, unsigned long long loopCount)
{
    ...
    transitions[0].outputArcs[0].output = 4;
    ...
    transitions[1].inputArcs[0].place = 1;
    ...
    transitions[1].outputArcs[0].output = 5;
    ...
    transitions[2].inputArcs[0].place = 2;
    ...
    transitions[2].outputArcs[0].output = 6;
    ...
    transitions[3].inputArcs[0].place = 3;
    ...
    transitions[3].outputArcs[0].output = 7;
    ...
    transitions[4].inputArcs[0].place = 4;
    ...
    transitions[7].outputArcs[0].output = 11;
    transitions[7].outputArcsCount++;
    transitions[7].outputArcs[1].output = 12;
    transitions[7].outputArcsCount++;

    transitions[8].distribution.type = EXPONENTIAL;
    transitions[8].distribution.a = 0.1f;
    transitions[8].inputArcs[0].place = 13;
    ...
    transitions[10].inputArcs[1].place = 10;
    ...
    transitions[10].inputArcsCount++;
    transitions[10].inputArcs[2].place = 12;
    ...
    transitions[10].inputArcsCount++;
    transitions[10].outputArcs[0].output = 13;
    transitions[10].outputArcsCount++;
    transitions[10].outputArcs[1].output = 6;
    transitions[10].outputArcsCount++;

    transitions[11].distribution.type = EXPONENTIAL;
    transitions[11].distribution.a = 0.1f;
    transitions[11].inputArcs[0].place = 13;
    ...
    transitions[11].inputArcs[1].place = 11;
    ...
    transitions[11].inputArcsCount++;
    transitions[11].inputArcs[2].place = 12;
    ...
    transitions[16].inputArcs[1].place = 13;
    ...
    transitions[12].inputArcs[0].place = 8;
    ...
    transitions[12].inputArcs[1].place = 12;
    ...
    transitions[12].inputArcsCount++;
    transitions[12].inputArcs[2].place = 13;
    ...
    transitions[13].inputArcs[1].place = 12;
    ...
    transitions[13].inputArcsCount++;
    transitions[13].inputArcs[2].place = 13;
    ...
    transitions[14].inputArcs[1].place = 12;
    ...
    transitions[14].inputArcsCount++;
    transitions[14].inputArcs[2].place = 13;
    ...
    transitions[15].inputArcs[1].place = 12;
    ...
    transitions[15].inputArcsCount++;
    transitions[15].inputArcs[2].place = 13;
    ...
    transitions[15].inputArcsCount++;
    transitions[15].outputArcs[0].output = 13;
    transitions[15].outputArcsCount++;
    transitions[15].outputArcs[1].output = 7;
    transitions[15].outputArcsCount++;
